...
var DrugAdapter_1 = require("../adapter/DrugAdapter");
var makeFindByName = function (database) {
    return function (name) { return __awaiter(void 0, void 0, void 0, function () {
        var drugData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database.queryMany('select d.name, d.presentation, d.description, ap.method, ap.procedure, r.reaction, dca.classification ' +
                ...
                case 1:
                    drugData = _a.sent();
                    return [2 /*return*/, drugData.length > 0 ? DrugAdapter_1.default.FromDB(drugData) : null];
            }
        });
    }); };
};
